...
static POPStaticAnimatablePropertyState _staticStates[] =
{
  ...
  {kPOPScrollViewScrollIndicatorInsets,
    ^(UIScrollView *obj, CGFloat values[]) {
      values[0] = obj.verticalScrollIndicatorInsets.top;
      values[1] = obj.verticalScrollIndicatorInsets.left;
      values[2] = obj.verticalScrollIndicatorInsets.bottom;
      values[3] = obj.verticalScrollIndicatorInsets.right;
    },
    ^(UIScrollView *obj, const CGFloat values[]) {
